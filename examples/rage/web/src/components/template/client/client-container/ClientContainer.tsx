...
import { ConfigContext } from 'slate-frontend';
  ...
  useEffect(() => {
    function setupGame(): void {
      const variables: Record<string, string> = {
        ...
        'external.override.texts.txt': configContext.swfOverrideTexts,
        'external.override.variables.txt': configContext.swfOverrideVariables,
