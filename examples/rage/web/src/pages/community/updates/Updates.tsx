...
import { Card, Column, Container, Jumbotron, Loading, setURL } from 'slate-frontend';
    ...
    <UserLayout section="updates">
      ...
      <Container>
        <Loading isLoading={state.showSpinner}>
          ...
          <Column side="right">
            <Card header="Notice">
              <p>Slate is an actively developed project and as a result; you may encounter bugs.</p>
              <p>
              ...
              <p>
                The Slate development team takes bugs with seriously and aims to fix all bugs within 24 hours. Bugs will then receive a
