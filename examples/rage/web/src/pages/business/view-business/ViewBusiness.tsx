...
import { Business, BusinessType } from 'slate-rp-interfaces';
import React, { FunctionComponent, useContext, useEffect, useState } from 'react';
import { ConfigContext, Container, Jumbotron, Loading, setURL } from 'slate-frontend';
  ...
  return (
    <UserLayout section="view_business">
      <Loading isLoading={state.showSpinner}>
        <Jumbotron
          style={{ backgroundImage: `url('${configContext.siteLink}/swfs/assets/c_images/corp-badges/${state.business?.badge}.gif')` }}
        ...
        <Container>
          <BackButton />
          {!state.showSpinner && <BusinessHandler business={state.business} />}
        </Container>
      </Loading>
    </UserLayout>
  );
