...
import { Button, Card, Column, ConfigContext, Container, Form, Icon, Jumbotron, Loading, setURL } from 'slate-frontend';
            ...
            <Card>
              <Form className="">
                ...
                <div className="mt-3 text-right">
                  <Button color="success" style={{ fontSize: 14 }}>
                    Save Changes
                  </Button>
                </div>
              </Form>
            ...
            <Card>
              ...
              {state?.application?.job?.business !== undefined ? (
                <div
                  ...
                  style={{
                    background: `url(${configContext.siteLink}/swfs/assets/c_images/corp-badges/${state?.application?.job?.business?.badge}.gif) 10px no-repeat`,
                  }}
                >
                  <div className="user-count mr-2">{state?.application?.job?.vacantSpots}</div>
                  <div className="name">{state?.application?.job?.name}</div>
                  <div className="desc">
                    <span className="mr-2">
                      Pays <b>${state?.application?.job?.salary}/hour</b>
                    </span>
                    <span className="mr-2">
                      At <b>{state?.application?.job?.business?.name}</b>
                    </span>
                  </div>
                </div>
              ) : (
